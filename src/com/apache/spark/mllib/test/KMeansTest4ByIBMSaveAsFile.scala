  ...
  def main(args: Array[String]) {
    ...
    val result1 = parsedTrainingData.map {
      line =>
        ...
        line + " " + prediction
    }.saveAsTextFile("hdfs://219.219.220.149:9000/xubo/spark/output/mllib/KMeansTest4ByIBmSaveAsFile/" + iString + "/train")
    ...
    val result2 = parsedTestData.map {
      line =>
        val prediction = clusters.predict(line)
        line + " " + prediction
    }.saveAsTextFile("hdfs://219.219.220.149:9000/xubo/spark/output/mllib/KMeansTest4ByIBmSaveAsFile/" + iString + "/test")
