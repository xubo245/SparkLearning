...
import org.apache.spark.mllib.clustering.{PowerIterationClustering, PowerIterationClusteringLearning, PowerIterationClusteringModel}
import org.apache.spark.mllib.util.MLlibTestSparkContext
import org.apache.spark.mllib.util.TestingUtils._
import org.apache.spark.util.{SparkLearningFunSuite, Utils}

import scala.collection.mutable
import scala.util.Random

class PowerIterationClusteringSuite extends SparkLearningFunSuite {
  ...
  test("power iteration clustering") {
    ...
    /** ****************add by xubo 20160613 *************/
    model2.assignments.foreach { a =>
      println(s"${a.cluster} -> ${a.id}")
    }
    /** ****************add by xubo 20160613 *************/
...
object PowerIterationClusteringSuite extends SparkLearningFunSuite {
